...
visualShapeId = pb.createVisualShape(
    ...
    fileName='002_pybullet_first_steps/random_urdfs/000/000.obj',
    rgbaColor=None,
    meshScale=[0.1, 0.1, 0.1])

collisionShapeId = pb.createCollisionShape(
    shapeType=pb.GEOM_MESH,
    fileName='002_pybullet_first_steps/random_urdfs/000/000_coll.obj',
    meshScale=[0.1, 0.1, 0.1])
...
texture_paths = glob.glob(os.path.join('002_pybullet_first_steps/dtd', '**', '*.jpg'), recursive=True)
